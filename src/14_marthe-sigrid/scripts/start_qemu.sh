...
echo "Starting QEMU"
qemu-system-i386 -S -gdb tcp::1234 -cdrom /workspaces/2026-ikt218-osdev/build/14_marthe-sigrid/kernel.iso -m 64 -audiodev sdl,id=sdl1,out.buffer-length=40000 -machine pcspk-audiodev=sdl1 -serial pty &
QEMU_PID=$!
